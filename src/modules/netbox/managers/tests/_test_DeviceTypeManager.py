...
if __name__ == "__main__":
    ...
    device_types_yaml_path = "resources/etc/connectors/netbox/config/device_types.yaml"

    netbox_api.devicetype_manager.print_all_device_types()

    netbox_api.devicetype_manager.create_device_types_from_yaml(
        yaml_file=device_types_yaml_path
    )
