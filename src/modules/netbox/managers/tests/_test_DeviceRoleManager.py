...
if __name__ == "__main__":
    ...
    roles_yaml_path = "resources/etc/connectors/netbox/config/device_roles.yaml"
    ...
    try:
        netbox_api.role_manager.create_roles_from_yaml(roles_yaml_path)
        logging.debug("Roles imported and created successfully.")
    except requests.exceptions.RequestException as e:
        logging.debug("Error importing and creating roles:", e)
