...
if __name__ == "__main__":
    ...
    platforms_yaml_path = "resources/etc/connectors/netbox/config/platforms.yaml"
    ...
    try:
        netbox_api.platform_manager.create_platforms_from_yaml(platforms_yaml_path)
        logging.debug("Platforms imported and created successfully.")
    except requests.exceptions.RequestException as e:
        logging.debug("Error importing and creating platforms:", e)
